...
export function Navbar() {
  ...
  return (
    <>
      <nav class="z-10 relative" x-data="{open:false,menu:false, lokasi:false}">
        {/* bg-dark */}
        {/* full width */}
        <div class="sticky z-10 bg-dark shadow">
          {/* max-width */}
          <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
            {/* main navbar */}
            <div class="relative flex items-center justify-between h-16">
              <Link class="flex-shrink-0" to="/#top" className="mr-32">
                <img class="block lg:hidden h-10 w-16" src={logo} alt="Logo" />
                <img
