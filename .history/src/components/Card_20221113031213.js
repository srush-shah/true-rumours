...
function Card(data) {
  ...
  return (
    <div class="max-w-2xl mx-auto">
      <div class="bg-white shadow-md border border-gray-200 rounded-lg w-96 dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
        ...
        <div class="p-5">
          ...
          <p class="font-normal text-gray-700 mb-3 dark:text-gray-400 h-12 overflow-hidden">
            {article.description}
          </p>
          <a
            href="#"
