      ...
      <div class="container px-5 py-10 mx-auto">
        <div class="flex items-center lg:w-4/5 mx-20 border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
          ...
          <div class="flex-grow sm:text-left mt-6 sm:mt-0">
            ...
            <p class="leading-relaxed text-base">{articles[0].description}</p>
        ...
        <div class="flex items-center lg:w-4/5 mx-20 border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
          ...
          <div class="flex-grow sm:text-left mt-6 sm:mt-0">
            ...
            <p class="leading-relaxed text-base">{articles[1].description}</p>
            <a class="mt-3 text-indigo-500 inline-flex items-center">
              Learn More
              <svg
                fill="none"
        ...
        <div class="flex items-center lg:w-4/5 mx-20 sm:flex-row flex-col">
          ...
          <div class="flex-grow sm:text-left mt-6 sm:mt-0">
            ...
            <p class="leading-relaxed text-base">{articles[2].description}</p>
            <a class="mt-3 text-indigo-500 inline-flex items-center">
              Learn More
              <svg
                fill="none"
