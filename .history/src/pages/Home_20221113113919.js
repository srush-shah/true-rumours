  ...
  return (
    <div className="mb-10 w-screen overflow-clip">
      <div className=" block">
        ...
        >
          <Card data={sports[0] ? s[0] : news[0]} />
          <Card data={sports[1] ? s[1] : news[1]} />
          <Card data={sports[2] ? s[2] : news[2]} />
          <Card data={sports[3] ? s[3] : news[3]} />
          <Card data={sports[4] ? s[4] : news[4]} />
          <Card data={sports[5] ? s[5] : news[5]} />
          <Card data={sports[6] ? s[6] : news[6]} />
          <Card data={sports[7] ? s[7] : news[7]} />
          <Card data={sports[8] ? s[8] : news[8]} />
        </div>
        <h1 className="ml-12 sticky text-3xl font-bold w-full bg-white my-10">
          Finance{" "}
          <button>
