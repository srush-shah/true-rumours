    ...
    <div className="mb-10 w-screen overflow-clip">
      <div className=" block">
        ...
        >
          ...
          <Card data={catNews[1] ? catNews[1] : news[0]} />
          <Card data={catNews[2] ? catNews[2] : news[0]} />
          <Card data={catNews[3] ? catNews[3] : news[0]} />
          <Card data={catNews[4] ? catNews[4] : news[0]} />
          <Card data={catNews[5] ? catNews[5] : news[0]} />
          <Card data={catNews[6] ? catNews[6] : news[0]} />
          <Card data={catNews[7] ? catNews[0] : news[0]} />
          <Card data={catNews[8] ? catNews[0] : news[0]} />
        </div>
        <h1 className="ml-12 sticky text-3xl font-bold w-full bg-white my-10">
          Finance{" "}
          <button>
