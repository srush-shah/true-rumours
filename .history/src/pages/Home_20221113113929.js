  ...
  return (
    <div className="mb-10 w-screen overflow-clip">
      <div className=" block">
        ...
        >
          <Card data={finance[0] ? catNews[0] : news[0]} />
          <Card data={finance[1] ? catNews[1] : news[1]} />
          <Card data={finance[2] ? catNews[2] : news[2]} />
          <Card data={finance[3] ? catNews[3] : news[3]} />
          <Card data={finance[4] ? catNews[4] : news[4]} />
          <Card data={finance[5] ? catNews[5] : news[5]} />
          <Card data={finance[6] ? catNews[6] : news[6]} />
          <Card data={finance[7] ? catNews[7] : news[7]} />
          <Card data={finance[8] ? catNews[8] : news[8]} />
        </div>
      </div>
    </div>
  );
