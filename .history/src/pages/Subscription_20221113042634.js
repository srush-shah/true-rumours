    ...
    <section class="text-gray-600 body-font overflow-hidden">
      ...
      <div class="container px-5 pt-10 pb-24 mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 -m-4">
          <div class="p-4 w-96">
            <div class="h-full p-6 rounded-lg border-2 border-green-300 flex flex-col relative overflow-hidden">
              ...
              <button class="flex items-center mt-auto text-white bg-green-400 border-0 py-2 px-4 w-2/3 focus:outline-none hover:bg-gray-500 rounded">
                Subscribe
                <svg
                  fill="none"
                  stroke="currentColor"
          ...
          <div class="p-4 w-96">
            <div class="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
              ...
              <a href=""><button class="flex items-center mt-auto text-white bg-indigo-500 border-0 py-2 px-4  w-2/3 focus:outline-none hover:bg-indigo-600 rounded">
                Subscribe
                <svg
                  fill="none"
                  stroke="currentColor"
