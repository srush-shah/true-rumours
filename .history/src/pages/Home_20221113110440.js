            ...
            <div className="container px-28 py-10 mx-auto">
              {isAdActive ? (
                ...
                <div className="grid grid-cols-1 grid-flow-row gap-8 overflow-scroll mx-10 mt-10 -ml-28">
                  <Card data=[0] ? catNews[0] : news[0]} />
                  <Card data=[1] ? catNews[1] : news[1]} />
                  <Card data=[2] ? catNews[2] : news[2]} />
                  <Card data=[3] ? catNews[3] : news[3]} />
                  <Card data=[4] ? catNews[4] : news[4]} />
                  <Card data=[5] ? catNews[5] : news[5]} />
                </div>
              )}
            </div>
          </div>
