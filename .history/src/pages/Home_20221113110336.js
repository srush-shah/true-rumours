      ...
      <div className=" block">
        ...
        <div className="grid grid-cols-2 gap-6 h-screen mt-10">
          ...
          <div className="grid grid-cols-1 grid-flow-row overflow-scroll">
            ...
            <Card data={tren[1] ? catNews[1] : news[1]} />
            <Card data={tren[2] ? catNews[2] : news[2]} />
            <Card data={tren[3] ? catNews[3] : news[3]} />
            <Card data={tren[4] ? catNews[4] : news[4]} />
            <Card data={tren[5] ? catNews[5] : news[5]} />
              )}
            </div>
          </div>
