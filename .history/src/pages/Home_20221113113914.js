  ...
  return (
    <div className="mb-10 w-screen overflow-clip">
      <div className=" block">
        ...
        >
          <Card data={sports[0] ? catNews[0] : news[0]} />
          <Card data={sports[1] ? catNews[1] : news[1]} />
          <Card data={sports[2] ? catNews[2] : news[2]} />
          <Card data={sports[3] ? catNews[3] : news[3]} />
          <Card data={sports[4] ? catNews[4] : news[4]} />
          <Card data={sports[5] ? catNews[5] : news[5]} />
          <Card data={sports[6] ? catNews[6] : news[6]} />
          <Card data={sports[7] ? catNews[7] : news[7]} />
          <Card data={sports[8] ? catNews[8] : news[8]} />
        </div>
        <h1 className="ml-12 sticky text-3xl font-bold w-full bg-white my-10">
          Finance{" "}
          <button>
