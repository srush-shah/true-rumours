    ...
    <div className="mb-10 w-screen overflow-clip">
      <div className=" block">
        ...
        >
          ...
          <Card data={catNews[2] ? catNews[0] : news[0]} />
          <Card data={catNews[3] ? catNews[0] : news[0]} />
          <Card data={catNews[4] ? catNews[0] : news[0]} />
          <Card data={catNews[5] ? catNews[0] : news[0]} />
          <Card data={catNews[6] ? catNews[0] : news[0]} />
