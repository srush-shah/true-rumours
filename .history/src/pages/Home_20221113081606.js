...
function Home() {
  ...
  const [isActive, setS] = useState(false);
  ...
  return (
    <div className="mb-10">
      <div className=" block">
        ...
        <h1 className="ml-12 sticky text-3xl font-bold w-full bg-white my-10">
          Sports{" "}
          <IoIosArrowDropdownCircle className="inline" onClick={() => {}} />
        </h1>
        <div
          id="sports"
          className={`{} grid grid-rows-1 grid-flow-col gap-8 overflow-scroll mx-10 `}
        >
          <Card data={news[0]} />
          <Card data={news[1]} />
          <Card data={news[2]} />
